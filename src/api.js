...
import { mix as mixRelational, relation, state } from 'timeforce-relational';
import { mix as mixFormat } from 'timeforce-format';
import { mix as mixValidate, validate } from 'timeforce-validate';
...
mixFormat(timeforceApi.Collection, timeforceApi.Model);
mixValidate(timeforceApi.Model);
timeforceApi.configValidator = function (_validator, requiredErrorMessage = 'Invalid data') {
    timeforceApi.Model.prototype.validator = _validator;
    timeforceApi.Model.prototype.requiredErrorMessage = requiredErrorMessage;
}
